...
public class BufferedFileTester {
	...
	for (int i=0; i<iter; i+=1)f.readLArray(by2);
    ...
    @Test public void testBufferedFile() throws Exception {
    ...
    @Test public void testBufferedStreams() throws Exception {
