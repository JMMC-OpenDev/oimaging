        ...
        try {
            ...
            if (FileUtils.isRemote(fileLocation)) {
                ...
                if (localCopy != null) {
                    ...
                    fitsImageFile = FitsImageLoader.load(localCopy.getAbsolutePath(), true);
                } else {
                    // download failed:
                    fitsImageFile = null;
                }
                ...
                fitsImageFile = FitsImageLoader.load(fileLocation, true);
            }
        } catch (AuthenticationException ae) {
            throw new IOException("Could not load the file : " + fileLocation, ae);
        } catch (IOException ioe) {
            ...
            throw new IOException("Could not load the file : " + fileLocation, iae);
        }
