 ...
 */
public class FastAbstractObjectList implements Cloneable, Serializable {

    /** For serialization. */
    private static final long serialVersionUID = 7789833772597351595L;
    /** The default initial capacity of the list. (4096) */
    public static final int DEFAULT_INITIAL_CAPACITY = 4096;
    /** Storage for the objects. */
    protected transient Object[] objects;
     ...
     */
    protected FastAbstractObjectList() {
     ...
     */
    protected FastAbstractObjectList(final int initialCapacity) {
     ...
     */
    protected final Object get(final int index) {
        Object result = null;
     ...
     */
    protected final void set(final int index, final Object object) {
        if (index < 0) {
    ...
    /**
     * Increases the capacity of this <tt>FastAbstractObjectList</tt> instance, if
    ...
    public final void ensureCapacity(final int minCapacity) {
        if (minCapacity >= this.objects.length) {
            final Object[] enlarged = new Object[minCapacity + this.increment];
     ...
     */
    protected final int indexOf(final Object object) {
    ...
    public Object clone() throws CloneNotSupportedException {
        final FastAbstractObjectList clone = (FastAbstractObjectList) super.clone();
