...
public final class ImageData extends Data {
   ...
   */
  protected class ImageDataTiler extends fr.nom.tam.image.ImageTiler {
  ...
  protected void fillHeader(Header head) throws FitsException {
    ...
    head.addValue("EXTEND", true, "FITS dataset may contain extensions");  // Just in case!
    head.addValue("PCOUNT", 0, "No extra parameters");
    head.addValue("GCOUNT", 1, "one data group (required keyword)");
  }
