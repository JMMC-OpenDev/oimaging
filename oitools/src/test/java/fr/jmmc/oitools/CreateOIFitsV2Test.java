...
public class CreateOIFitsV2Test {
    ...
    private static final int N_VIS = 5;
    private static final int N_VIS2 = 6;
    private static final int N_T3 = 3;
    private static final int N_FLUX = 11;
    ...
    public void create() throws IOException, FitsException {
        ...
        logger.info("create : XML DESC : \n" + XmlOutputVisitor.getXmlDesc(oiFitsFile, true));
    ...
    private static void createPrimaryHeader(OIFitsFile oiFitsFile) {
        ...
        imageHDU.setDate("03/09/2017");
        imageHDU.setDateObs("12/06/2017");
    ...
    private static void createOICorr(OIFitsFile oiFitsFile) {
        ...
        final int nbRows = 526;
        final OICorr oicorr = new OICorr(oiFitsFile, nbRows);
        ...
        int k = 0;
        for (int i = 1; i < N_DATA && k < nbRows; i += 13) {
            for (int j = i + 1; j < N_DATA && k < nbRows; j += 7) {
                iIndx[k] = i;
                jIndx[k] = j;
