...
public final class BinaryTableHDU
  ...
  public static Data encapsulate(Object o) throws FitsException {
    ...
    if (o instanceof fr.nom.tam.util.ColumnTable) {
      return new BinaryTable((fr.nom.tam.util.ColumnTable) o);
  ...
  public static boolean isData(Object o) {
    ...
    if (o instanceof fr.nom.tam.util.ColumnTable || o instanceof Object[][]
            || o instanceof Object[]) {
      return true;
    } else {
      return false;
