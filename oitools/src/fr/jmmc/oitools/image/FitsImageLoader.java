 ...
 * 
 * TODO: add support for CUNITn keywords (aspro_kewords.fits):
 * CRPIX1  = '128.500000'
 * CDELT1  = '0.000750'
 * CRVAL1  = '0.000375'
 * CUNIT1  = '  ARCSEC'
...
public final class FitsImageLoader {
    ...
    private static void processKeywords(final Header header, final FitsImage image) throws FitsException {
        ...
        final List<FitsHeaderCard> headerCards = image.getHeaderCards(header.getNumberOfCards());
