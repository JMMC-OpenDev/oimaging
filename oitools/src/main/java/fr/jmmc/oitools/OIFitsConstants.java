...
public interface OIFitsConstants {
    ...
    public final static String KEYWORD_MJD_OBS = "MJD_OBS";
    /** MJD_END = End of observation (MJD) */
    public final static String KEYWORD_MJD_END = "MJD_END";
    ...
    public final static String KEYWORD_AMPTYP_DIFF = "differencial";
    ...
    public final static String KEYWORD_PHITYP_DIFF = "differencial";
    /** AMPORDER keyword V2 */
