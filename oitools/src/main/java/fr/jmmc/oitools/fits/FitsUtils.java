...
/**
 * This utility class gathers several methods related to Fits binary table handling
 * @author bourgesl
 */
public final class FitsUtils {
    ...
    static {
        ...
        FITS_STANDARD_KEYWORDS.add(FitsConstants.KEYWORD_COMMENT);
    ...
    public static boolean dumpFile(final String absFilePath, final boolean dumpValues) {
        ...
        try {
            ...
            logger.info("FitsUtils.dumpFile: duration = " + 1e-6d * (end - start) + " ms.");
        }
