...
public class DataModel {
    ...
    /** flag to support or not additional columns for Image Reconstruction Imaging before a global support
    ...
    public static void dumpKeyword(final KeywordMeta keyword, final StringBuilder sb) {
        ...
        dumpMeta(keyword, sb);
        // specific members :
        sb.append("<mandatory>").append(keyword.isMandatory()).append("</mandatory>\n");
        sb.append("</keyword>\n");
    }
