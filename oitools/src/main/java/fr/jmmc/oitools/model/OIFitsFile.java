...
public class OIFitsFile extends OIFits {
    ...
    /** (optional) image HDU to get all FITS keywords of the primary HDU (history, eso hierarch ...) */
    private FitsImageHDU imageHdu = null;
    ...
    /**
     * @return the (optional) image HDU to get all FITS keywords of the primary HDU
     */
    public final FitsImageHDU getImageHdu() {
        return imageHdu;
    }

    /**
     * Define the (optional) image HDU to get all FITS keywords of the primary HDU
     * @param imageHdu (optional) image HDU to get all FITS keywords of the primary HDU
     */
    public final void setImageHdu(final FitsImageHDU imageHdu) {
