...
//            this.checker.addFileIssue(CheckRule.FILE_NOT_LOADED, absFilePath, fe.getMessage());
     ...
     * @throws FitsException if any FITS error occurred
     */
    private void processHDUnits(final BasicHDU[] hdus) throws FitsException, IOException {
        ...
        if (imageOiData != null) {
            List<FitsImageHDU> fitsImageHDUs = FitsImageLoader.processHDUnits(this.oiFitsFile.getName(), hduList, false);
