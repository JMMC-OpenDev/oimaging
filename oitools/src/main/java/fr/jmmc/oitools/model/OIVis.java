...
public final class OIVis extends OIData {
    ...
    public OIVis(final OIFitsFile oifitsFile) {
        ...
        if (DataModel.hasOiModelColumnsSupport()) {
            ...
            addColumnMeta(new WaveColumnMeta(OIFitsConstants.COLUMN_NS_MODEL_VISAMP, "model of the visibility amplitude", Types.TYPE_DBL, Units.NO_UNIT, null, RANGE_VIS, true, this));
            addColumnMeta(new WaveColumnMeta(OIFitsConstants.COLUMN_NS_MODEL_VISPHI, "model of the visibility phase", Types.TYPE_DBL, Units.UNIT_DEGREE, null, RANGE_ANGLE, true, this));
