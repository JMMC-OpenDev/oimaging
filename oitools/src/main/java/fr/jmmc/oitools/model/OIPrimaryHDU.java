...
public final class OIPrimaryHDU extends FitsImageHDU {
    ...
    private final static KeywordMeta KEYWORD_ORIGIN = new KeywordMeta(FitsConstants.KEYWORD_ORIGIN,
            "Insitution responsible for file creation name", Types.TYPE_CHAR);
    /**
    ...
    private final static KeywordMeta KEYWORD_DATE_OBS = new KeywordMeta(FitsConstants.KEYWORD_DATE_OBS,
            "Strat date of observation", Types.TYPE_CHAR);
    /**
    ...
    private final static KeywordMeta KEYWORD_INSTRUME = new KeywordMeta(FitsConstants.KEYWORD_INSTRUME,
            "A generic identifition of this instrument", Types.TYPE_CHAR);
    /**
    ...
    private final static KeywordMeta KEYWORD_RADECSYS = new KeywordMeta(OIFitsConstants.KEYWORD_RADECSYS,
            "VCoordinate reference frame", Types.TYPE_CHAR, true, NO_STR_VALUES);
    /**
    ...
    private final static KeywordMeta KEYWORD_MJD_OBS = new KeywordMeta(OIFitsConstants.KEYWORD_MJD_OBS,
            "Start of observation (MJD)", Types.TYPE_DBL, true, NO_STR_VALUES);
    /**
    ...
    private final static KeywordMeta KEYWORD_MJD_END = new KeywordMeta(OIFitsConstants.KEYWORD_MJD_END,
            "End of observation (MJD)", Types.TYPE_DBL, true, NO_STR_VALUES);
    /**
    ...
    private final static KeywordMeta KEYWORD_BASE_MAX = new KeywordMeta(OIFitsConstants.KEYWORD_BASE_MAX,
            "Maxmimum projected baseline length (m)", Types.TYPE_DBL, true, NO_STR_VALUES);
    /**
    ...
    private final static KeywordMeta KEYWORD_WAVELMIN = new KeywordMeta(OIFitsConstants.KEYWORD_WAVELMIN,
            "Minimum wavelength (m)", Types.TYPE_DBL, true, NO_STR_VALUES);
    /**
    ...
    private final static KeywordMeta KEYWORD_WAVELMAX = new KeywordMeta(OIFitsConstants.KEYWORD_WAVELMAX,
            "Maximum wavelength (m)", Types.TYPE_DBL, true, NO_STR_VALUES);
    /**
    ...
    /**
     * Get the value of DATE_OBS keyword
     * @return the value of DATE_OBS keyword
     */
     ...
     * @param dateObs value of DATE_OBS keyword
     */
     ...
     */
    public void setTexpTime(float texptime) {
     ...
     */
    public void setMJDObs(float mjdObs) {
     ...
     */
    public void setMJDEnd(float mjdEnd) {
     ...
     */
    public void setWavelMin(float wavelmin) {
     ...
     */
    public void setWavelMax(float wavelmax) {
     ...
     */
    public void setSpecRes(float specRes) {
     ...
     */
    public void setVis2Err(float vis2err) {
     ...
     */
    public void setVisPhiErr(float visphierr) {
     ...
     */
    public void setT3PhiErr(float t3phierr) {
