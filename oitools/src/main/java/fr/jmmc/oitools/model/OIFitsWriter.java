...
public class OIFitsWriter {
    ...
    private void createImageOiHDUnits(final Fits fitsFile, ImageOiData imageOiData) throws FitsException, IOException {
        ...
        // Add image tables
        FitsImageWriter.createHDUnits(fitsFile, imageOiData.getFitsImageHDUs(), null, 0); // TODO
     ...
     */
    private BasicHDU createBinaryTable(final Table table) throws FitsException, IOException {
        if (logger.isLoggable(Level.FINE)) {
