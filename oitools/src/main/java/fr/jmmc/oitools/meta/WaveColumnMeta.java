...
public final class WaveColumnMeta extends ArrayColumnMeta {
     ...
     * @param oiData OIData object to resolve OIWaveLength reference
     */
    public WaveColumnMeta(final String name, final String desc, final Types dataType, final String errName, final OIAbstractData oiData) {
        this(name, desc, dataType, false, false, NO_STR_VALUES, Units.NO_UNIT, errName, null, oiData);
    }
     ...
     */
    public WaveColumnMeta(final String name, final String desc, final Types dataType, final Units unit,
            final String errName, final OIAbstractData oiData) {
        this(name, desc, dataType, false, false, NO_STR_VALUES, unit, errName, null, oiData);
    }
