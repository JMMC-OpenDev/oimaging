...
public class CellMeta {
     ...
     * @param is3D keyword/column is3D
     ...
     */
    protected CellMeta(final MetaType type, final String name, final String desc, final Types dataType, final boolean optional,
                       final boolean is3D, final int repeat,
